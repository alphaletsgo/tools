...
public final class DeviceUtils {
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            Context context = ALibs.getApp().getApplicationContext();
    ...
    public static void shutdown() {
        ...
        ALibs.getApp().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    public static void reboot() {
        ...
        ALibs.getApp().sendBroadcast(intent);
    }
    ...
    public static void reboot(final String reason) {
        PowerManager mPowerManager =
                (PowerManager) ALibs.getApp().getSystemService(Context.POWER_SERVICE);
        try {
