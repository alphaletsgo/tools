...
public final class NetworkUtils {
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) ALibs.getApp().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) ALibs.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
        return cm != null
